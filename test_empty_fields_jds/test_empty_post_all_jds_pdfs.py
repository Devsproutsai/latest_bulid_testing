...
#pytest test_empty_post_all_jds_docx.py -k "test_login or test_post_new_job_TC005_unicode_characters" --html=reportsssssss.html
...
class TestLoginAndEmptyPost:
    ...
    def test_post_new_job_TC001_empty_file(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'folder_path_for_empty_case_pdfs')
